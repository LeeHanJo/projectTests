...
public class BoardSerchImpl extends QuerydslRepositorySupport implements BoardSerch {
    public BoardSerchImpl () {
        super(Board.class);
    }

    @Override
    public Page<Board> serch1(Pageable pageable) {
    ...
    @Override
    public Page<Board> serchAll(String[] types, String keyword, Pageable pageable) {
        QBoard board = QBoard.board;
        JPQLQuery<Board> query = from(board);
    ...
    @Override
    public Page<BoardListAllDTO> serchWithAll(String[] types, String keyword, Pageable pageable) {
